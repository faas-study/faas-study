...
public class Order2RepositoryImpl implements Order2Repository {
    ...
    private final MongoClient mongoClient = MongoClients.create(
            MongoClientSettings.builder()
                    ...
                    .build());
    private final MongoDatabase database = mongoClient.getDatabase("order2");
    private final MongoCollection<Document> collection = database.getCollection("order2");
    ...
    public ArrayList<Order> findByTravelDateAndTrainNumber(Date travelDate, String trainNumber, Context context) {
        ...
        String travelDateStr = DateUtils.dateToStringLong(travelDate);
        logger.log("travelDateStr:" + travelDateStr);
        logger.log("travelDatetoStr:" + travelDate.toString());
    ...
    public static void main(String[] args) {
        Order2RepositoryImpl orderRepository = new Order2RepositoryImpl();
        orderRepository.findByTravelDateAndTrainNumber(new Date(1501257600000L), "G1237", null);
    }
}
