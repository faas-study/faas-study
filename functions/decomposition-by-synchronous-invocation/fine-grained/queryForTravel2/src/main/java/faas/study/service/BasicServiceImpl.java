...
public class BasicServiceImpl implements BasicService {
    ...
    @Override
    public Response queryForTravel(TicketRequest ticketRequest, TripResponse tripResponse) {
        ...
        info.setTrip(trip);
        info.setStartingPlace(startingPlaceName);
        info.setEndPlace(endPlaceName);
        ...
        tripResponse.setPriceForConfortClass(result.getPrices().get("confortClass"));
        tripResponse.setPriceForEconomyClass(result.getPrices().get("economyClass"));
